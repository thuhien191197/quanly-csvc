                            ...
                            <div className={classes.cardDetails}>
                                <CardContent>
                                    <Typography component="h2" variant="h6" >
										<FormattedMessage  id="canbo.title" defaulMesage="Cán bộ" />: 
											{user.fullname}
                                    </Typography>
                                    <Typography  component="p" gutterBottom noWrap className={classes.posrt}>
										<FormattedMessage  id="phone.title" defaulMesage="DĐ" />: 
											{user.phone}
                                    </Typography>
									<Typography  component="p" gutterBottom noWrap className={classes.posrt}>
										<FormattedMessage  id="donvi.title" defaulMesage="Đơn vị" />:
											{this.handleShowDonvi(user.id_donvi)}
									</Typography>
									<Typography  component="p" gutterBottom noWrap className={classes.posrt}>
										<FormattedMessage  id="chucvu.title" defaulMesage="Chức vụ" />:
											{this.handleShowRole(user.id_role)}
									</Typography>
									<Typography  component="p" gutterBottom noWrap className={classes.whiteSpace}>
										<FormattedMessage  id="nhiemvu.title" defaulMesage="Nhiệm vụ" />:
										{this.handleShowMission(user.id_role)}
									</Typography>
